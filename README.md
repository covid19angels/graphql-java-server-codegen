...
[![CircleCI](https://img.shields.io/circleci/build/github/kobylynskyi/graphql-java-server-codegen)](https://circleci.com/gh/kobylynskyi/graphql-java-server-codegen/tree/master)
[![Codecov](https://img.shields.io/codecov/c/github/kobylynskyi/graphql-java-server-codegen)](https://codecov.io/gh/kobylynskyi/graphql-java-server-codegen)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

## Plugins

Please refer to:
* Gradle plugin: [graphql-java-server-codegen-gradle-plugin](https://github.com/kobylynskyi/graphql-java-server-codegen-gradle-plugin)
* Maven plugin: [grapqhl-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-server-codegen-maven-plugin) 
